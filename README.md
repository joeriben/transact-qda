...
bar) and the design notes in `docs/`.
...
- **Architecture and design notes** — `docs/`. `design-begleiten.md`
  states what the AI layer may and may not do;
  `design-methodological-positioning.md` places the tool in relation to
